    ...
    return (
        <nav>
            ...
            <ul className="navigation-bar-left-side">
                ...
                {window.location.href.includes('products/add')
                    ?
                    <li>
                        <a id="selectednavigation" href={window.location.origin + '/admin/products/add'}>
                    ...
                    :
                    <li>
                        <a href={window.location.origin + '/admin/products/add'}>
                            <i className="fa-solid fa-gem"></i>
                            <span>Produtos</span>
                        </a>
                    </li>
