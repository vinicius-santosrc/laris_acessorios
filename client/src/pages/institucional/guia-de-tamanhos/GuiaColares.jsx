                    ...
                    <div className="items-content-inst">
                        ...
                        <div className="content-inside-item">
                            <div className='content-inside-item-left-side'>
                                ...
                                <p className="childinside">O Comprimento do colar varia de pessoa para pessoa; portanto, existem algumas maneiras de descobrir qual é o tamanho ideal para você. Siga as instruções abaixo.</p>
